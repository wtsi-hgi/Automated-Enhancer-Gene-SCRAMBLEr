...
def compare_metrics(gene_data, title, filename):
    ...
    axis[0][1].scatter(gene_data["Std"], gene_data["Anomalous_score"], s = 0.2, c = "green")
    axis[0][2].scatter(gene_data["Std"], gene_data["Specific_gene_expression"], s = 0.2, c = "green")
    axis[0][3].scatter(gene_data["Std"], gene_data["Enhancer_count"], s = 0.2, c = "green")
    axis[0][4].scatter(gene_data["Std"], gene_data["Enhancer_proportion"], s = 0.2, c = "green")
    axis[0][5].scatter(gene_data["Std"], gene_data["Gene_size"], s = 0.2, c = "green")
    
    axis[1][0].scatter(gene_data["Anomalous_score"], gene_data["Std"], s = 0.2, c = "green")
    axis[1][1].scatter(gene_data["Anomalous_score"], gene_data["Anomalous_score"], s = 0.2, c = "green")
    axis[1][2].scatter(gene_data["Anomalous_score"], gene_data["Specific_gene_expression"], s = 0.2, c = "green")
    axis[1][3].scatter(gene_data["Anomalous_score"], gene_data["Enhancer_count"], s = 0.2, c = "green")
    axis[1][4].scatter(gene_data["Anomalous_score"], gene_data["Enhancer_proportion"], s = 0.2, c = "green")
    axis[1][5].scatter(gene_data["Anomalous_score"], gene_data["Gene_size"], s = 0.2, c = "green")
    
    axis[2][0].scatter(gene_data["Specific_gene_expression"], gene_data["Std"], s = 0.2, c = "green")
    axis[2][1].scatter(gene_data["Specific_gene_expression"], gene_data["Anomalous_score"], s = 0.2, c = "green")
    axis[2][2].scatter(gene_data["Specific_gene_expression"], gene_data["Specific_gene_expression"], s = 0.2, c = "green")
    axis[2][3].scatter(gene_data["Specific_gene_expression"], gene_data["Enhancer_count"], s = 0.2, c = "green")
    axis[2][4].scatter(gene_data["Specific_gene_expression"], gene_data["Enhancer_proportion"], s = 0.2, c = "green")
    axis[2][5].scatter(gene_data["Specific_gene_expression"], gene_data["Gene_size"], s = 0.2, c = "green")
    
    axis[3][0].scatter(gene_data["Enhancer_count"], gene_data["Std"], s = 0.2, c = "green")
    axis[3][1].scatter(gene_data["Enhancer_count"], gene_data["Anomalous_score"], s = 0.2, c = "green")
    axis[3][2].scatter(gene_data["Enhancer_count"], gene_data["Specific_gene_expression"], s = 0.2, c = "green")
    axis[3][3].scatter(gene_data["Enhancer_count"], gene_data["Enhancer_count"], s = 0.2, c = "green")
    axis[3][4].scatter(gene_data["Enhancer_count"], gene_data["Enhancer_proportion"], s = 0.2, c = "green")
    axis[3][5].scatter(gene_data["Enhancer_count"], gene_data["Gene_size"], s = 0.2, c = "green")
    
    axis[4][0].scatter(gene_data["Enhancer_proportion"], gene_data["Std"], s = 0.2, c = "green")
    axis[4][1].scatter(gene_data["Enhancer_proportion"], gene_data["Anomalous_score"], s = 0.2, c = "green")
    axis[4][2].scatter(gene_data["Enhancer_proportion"], gene_data["Specific_gene_expression"], s = 0.2, c = "green")
    axis[4][3].scatter(gene_data["Enhancer_proportion"], gene_data["Enhancer_count"], s = 0.2, c = "green")
    axis[4][4].scatter(gene_data["Enhancer_proportion"], gene_data["Enhancer_proportion"], s = 0.2, c = "green")
    axis[4][5].scatter(gene_data["Enhancer_proportion"], gene_data["Gene_size"], s = 0.2, c = "green")
    
    axis[5][0].scatter(gene_data["Gene_size"], gene_data["Std"], s = 0.2, c = "green")
    axis[5][1].scatter(gene_data["Gene_size"], gene_data["Anomalous_score"], s = 0.2, c = "green")
    axis[5][2].scatter(gene_data["Gene_size"], gene_data["Specific_gene_expression"], s = 0.2, c = "green")
    axis[5][3].scatter(gene_data["Gene_size"], gene_data["Enhancer_count"], s = 0.2, c = "green")
    axis[5][4].scatter(gene_data["Gene_size"], gene_data["Enhancer_proportion"], s = 0.2, c = "green")
